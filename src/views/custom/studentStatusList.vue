    ...
    <div class="flex_column hgt_full">
      ...
      <div class="flex_1">
        ...
        >
          ...
          <el-table-column prop="UniversityMajor" label="报读专业" width="200" />
          <el-table-column prop="XueLiShuXing" label="学历属性" width="100" />
          <el-table-column prop="XueJi" label="学籍编号" width="100" />
          <el-table-column prop="RealName" label="姓名" width="100" />
          <el-table-column prop="Sex" label="性别" width="50" />
          <el-table-column prop="ZhunKaoZheng" label="准考证号" width="120" :show-overflow-tooltip="true" />
    ...
    <div>
      ...
      >
        <div slot="left_content" class="p_both20 p-b-20">
          <stu-status-row-detail ref="refStuStatusDetail" />
...
export default {
  ...
  methods: {
    ...
    async getStudentStatusList() {
      ...
      const res = await getStudentStatusList(
