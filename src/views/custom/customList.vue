    ...
    <div class="flex_column hgt_full">
          ...
          <div class="between-center flex_wrap">
            ...
            <!-- <el-form-item>
              <div
                ...
                :class="{'color-1890ff':connecTelSuccess,'bg-1890ff':connecTelSuccess}"
              >
                <img
                  :src="connecTelSuccess?'/static/img/slice/wifiactive.png':'/static/img/slice/wifi.png'"
                  class="hgt18 m-r-10"
                  alt
                />
      ...
      <div class="between-center m-v-15">
        <div class="between-center m-l-10">
          <el-button type="primary" @click="openCustomDialog(1)">新增客户</el-button>
